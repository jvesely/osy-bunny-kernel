...
/*----------------------------------------------------------------------------*/
int SysCall::open( file_t* fd, const char* file_name, const char mode )
{
	return SYSCALL( SYS_FS_OPEN );
}
/*----------------------------------------------------------------------------*/
int SysCall::close( file_t fd )
{
	return SYSCALL( SYS_FS_CLOSE );
}
/*----------------------------------------------------------------------------*/
int SysCall::fread( file_t fd, void* buffer, size_t size )
{
